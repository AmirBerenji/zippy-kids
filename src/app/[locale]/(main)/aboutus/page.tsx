    ...
    <>
      ...
      <section className=" py-16 px-6 sm:px-12 md:px-20 lg:px-32">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
          <div className="bg-white rounded-lg shadow-md p-6 flex flex-col items-center text-center">
            <img
              alt="Jane Doe smiling female teacher with short brown hair wearing a blue blouse"
              className="rounded-full mb-4 w-36 h-36 object-cover"
              height="150"
              loading="lazy"
              src="/assets/images/aboutus/team4.jpg"
              width="150"
            />
            <h3 className="text-xl font-semibold text-[#2f3e4e]">Jane Doe</h3>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 flex flex-col items-center text-center">
            <img
              alt="John Smith male teacher with glasses and beard wearing a green shirt"
              className="rounded-full mb-4 w-36 h-36 object-cover"
              height="150"
              loading="lazy"
              ...
              width="150"
            />
            <h3 className="text-xl font-semibold text-[#2f3e4e]">John Smith</h3>
            <p className="text-orange-600 font-medium mb-2">
              Head of Curriculum
            </p>
            <p className="text-gray-600 text-sm">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 flex flex-col items-center text-center">
            <img
              alt="Emily Johnson female teacher with long blonde hair wearing a yellow cardigan"
              className="rounded-full mb-4 w-36 h-36 object-cover"
              height="150"
              loading="lazy"
            ...
            <p className="text-gray-600 text-sm">
              Dedicated to fostering strong relationships with families and
              partners.
            </p>
          </div>
          <div className="bg-white rounded-lg shadow-md p-6 flex flex-col items-center text-center">
            <img
              alt="Michael Lee male teacher with short black hair wearing a red polo shirt"
              className="rounded-full mb-4 w-36 h-36 object-cover"
              height="150"
              loading="lazy"
              src="/assets/images/aboutus/team3.jpg"
              width="150"
            />
            <h3 className="text-xl font-semibold text-[#2f3e4e]">
              Michael Lee
      ...
      <section className="bg-[#e6f0f6] text-white py-16 px-6 sm:px-12 md:px-20 lg:px-32 text-center">
        ...
        <p className="mb-8 max-w-3xl mx-auto text-lg text-[#2f3e4e]">
          Whether you're a parent, educator, or community member, we welcome you
          to be part of our journey to empower children everywhere.
        </p>
