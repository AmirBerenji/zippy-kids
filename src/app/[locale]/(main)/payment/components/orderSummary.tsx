...
import { BookingDraft, PaymentSummary, formatAmount } from "@/model/payment";
...
export default function OrderSummary({ booking, hours, summary }: Props) {
      ...
      <div className="bg-white rounded-2xl shadow-lg p-6 sm:p-8">
        ...
        <div className="flex items-center gap-4 pb-6 border-b border-gray-100">
          <img
            ...
            height={64}
            loading="lazy"
            className="w-16 h-16 rounded-full object-cover border-2 border-[#c6d9e3]"
          />
        ...
        <dl className="py-6 space-y-3 text-sm border-b border-gray-100">
          <div className="flex justify-between">
            <dt className="text-gray-500">{t("hourlyRate")}</dt>
            <dd className="text-[#2f3e4e] font-medium">
              {formatAmount(booking.hourlyRate, summary.currency)}
            </dd>
          </div>
          <div className="flex justify-between">
          ...
          <div className="flex justify-between">
            <dt className="text-gray-500">{t("serviceFee")}</dt>
            <dd className="text-[#2f3e4e] font-medium">
              {formatAmount(summary.serviceFee, summary.currency)}
            </dd>
          </div>
        </dl>
