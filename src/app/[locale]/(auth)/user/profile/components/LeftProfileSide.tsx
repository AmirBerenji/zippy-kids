...
export default function LeftProfileSide(prop:Props) {
  return (
    ...
    <p className="text-xs text-gray-400 text-center mt-1">{prop.userInfo.roles[0].toUpperCase()}</p>
    <p className="text-xs text-gray-400 text-center mt-1">{prop.userInfo.email}</p>
