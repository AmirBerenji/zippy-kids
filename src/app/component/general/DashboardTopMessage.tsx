    ...
    <span className='' >
      ...
      <div className="bg-gradient-to-br   from-indigo-600 via-purple-600 to-pink-500 relative overflow-hidden  ">
        ...
        <div className="absolute inset-0 opacity-10">
          ...
          <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-white rounded-full mix-blend-overlay filter blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
        </div>
          ...
          <div className="flex items-start justify-between gap-6">
            <div className="flex items-start gap-4 flex-1">
              ...
              <div className="flex-1 pt-1">
               ...
               Present your qualifications, certifications, and experience to stand out as a trusted childcare professional. A complete profile increases your visibility and helps families confidently connect with you.
                </p>
