...
export default function MiddlePart() {
  ...
  return (
     <section className="max-w-4xl mx-auto mt-20 bg-[#f7efe6] rounded-3xl px-8 py-20 flex flex-col sm:flex-row justify-between text-center sm:text-left space-y-10 sm:space-y-0 sm:space-x-10 relative">
